...
```text
총 SpawnBudget 425, 보상 단위 440 유지
15h P10 1,266편성 평균 113.20초, 누수 0
15h P50 평균 60.26초, 누수 0
30h P10 평균 34.81초, 누수 0
기존 집계 P10 주기와 차이 +0.86%
```
