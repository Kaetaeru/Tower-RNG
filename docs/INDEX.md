...
| 문서 | 상태 | 책임 |
|---|---|---|
| `reference/TOWER_CATALOG.md` | Active Template | 공식 분모, PowerBudget, 행동·수치·타격감 |
...
```text
1. TOWER_CATALOG에 역할별 기준 타워와 공식 분모 단계 작성
2. 역할별 EquivalentContribution 기준 전투 시나리오 작성
3. MONSTER_CATALOG에 스테이지 1 표준 일반형·군집·고체력 작성
4. STAGE_CATALOG에 지역 1의 3개 스테이지 작성
5. 확률 컴파일러·PowerBudget·SpawnCost 시뮬레이터 설계
6. STAT_TREE_CATALOG에 중심부와 첫 환생 전 노드 작성
7. 첫 7~15분 Defense XP·문·스탯 경제 시뮬레이션
8. STATE_LIFECYCLE 시스템 명세와 프로필 스키마 작성
