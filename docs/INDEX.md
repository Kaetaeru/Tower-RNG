...
```text
1. 스테이지 4·5 경량 웨이브 작성과 대표 편성 검사
2. 스테이지 4~15 문 가격과 전체 12~15시간 경제
3. 스테이지 9 지역 3 최종전 완전 검증
4. 스테이지 7·8 경량 검사
5. 스테이지 12 기준점과 10·11 경량 검사
6. 스테이지 13·14 경량 검사와 스테이지 15 실제 행동형 재검증
7. 중간 희귀도 실제 타워 작성
8. 변종·합체의 시간대별 전투력 기여
9. 실제 지원·제어 중첩과 자동 편성 평가
10. 지역 1 수직 슬라이스 구현
```